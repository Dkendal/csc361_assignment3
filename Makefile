...
GTEST_DIR = /usr/src/gmock-1.7.0/gtest

# Points to the root of Google Mock, relative to where this file is.
# Remember to tweak this if you move this file.
GMOCK_DIR =  /usr/src/gmock-1.7.0
...
# created to the list.
TESTS = packet_test rdp_listener
...
clean :
	rm -f bin/tests/* gmock.a gmock_main.a *.o
...
%_test.o : $(TEST_DIR)/%_test.cc \
	$(USER_DIR)/%.h $(GMOCK_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $<
